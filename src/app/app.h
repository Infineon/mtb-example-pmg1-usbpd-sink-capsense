...
* File Name: app.h
*
* Description: This is header file for the PMG1 MCU USB-PD Sink with Capsense 
*              Code Example. This file defines data structures and function 
...
/*  Indicates whether the Capsense scan on all widget is complete */
extern volatile bool gl_capsense_scan_complete;

/*  Indicates whether the Capsense processing on all widget is complete */
