...
* File Name: app.c
*
* Description: This is source code for the PMG1 MCU USB-PD Sink with Capsense
*              Code Example. This file implements functions for handling of  
...
bool system_sleep(cy_stc_pdstack_context_t *ptrPdStackContext, cy_stc_pdstack_context_t *ptrPdStack1Context)
{
    ...
    if (bc_slept)
    {
           ...
           )
        {
            ...
            /* Capsense HW block requires wakeup time */
